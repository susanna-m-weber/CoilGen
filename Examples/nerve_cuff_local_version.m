...
'target_mesh_file','cylindrical_ROI_diam1mm_length4p5mm.stl', ...
...
'tikonov_reg_factor',10000000,...
'make_cylndrical_pcb',true,...
'target_region_resolution', 10,...
'b_0_direction', [0; 1; 0],...
'sf_opt_method','tikkonov',...
'min_loop_signifcance',15,...
'conductor_cross_section_width',0.00001,...
'conductor_cross_section_height',0.00001,...
'save_stl_flag', true,...
