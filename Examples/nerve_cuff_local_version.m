...
project_name = 'Nerve Cuff';
coil_name = project_name;
%close all;
coil_layouts.out=CoilGen(...
'field_shape_function','x + abs(x)',...
'coil_mesh_file','open_cylinder.stl', ...
'target_mesh_file','cylindrical_ROI_diam1mm_length4mm_rotated.stl', ...
...
'sf_source_file','none', ...
'levels',6, ...
'pot_offset_factor', 0.65, ...%0.65, ...
'surface_is_cylinder_flag',false, ...
'interconnection_cut_width',0.0005, ...
...
'tikonov_reg_factor',10000000000,...
'make_cylndrical_pcb',false,...
'target_region_resolution', 20,...
'b_0_direction', [1; 0; 0],...
'sf_opt_method','tikkonov',...
'min_loop_signifcance',15,...
