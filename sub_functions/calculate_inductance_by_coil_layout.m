...
%Create the ".inp" input file
        ...
        fid = fopen(strcat('\Users\susam\CoilGen\output\',fast_henry_file_name), 'w+' );
        pause(1)
...
%Create the windows ".vbs" script file to run the ".inp" automatically
        ...
        fid2 = fopen(strcat('\Users\susam\CoilGen\output\',script_file_name), 'w+' );
        pause(1)
...
disp("Resistance (Ohm): ")
disp(coil_parts(part_ind).coil_resistance)
disp("Inductance (H): ")
disp(coil_parts(part_ind).coil_inductance)
